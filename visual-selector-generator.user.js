...
document.addEventListener('keydown', e => {
  ...
  if(window.location.hash == '#shaman-edit-article-selector'){
    var h = window.location.href.indexOf('#');
    window.history.replaceState(null, document.title, window.location.href.substring(0, h));
    execute();
  }
  ...
  function setvalues(modify){
      if(blogInfo) modify();
          ...
          var z = {host: blogHost, example_url: window.location.href, last_updated: now()};
  ...
  var onKeyPressed = function(ev) {
      ...
      if(ev.key == 'r'){
        ...
        setvalues(() => {
          ...
          xhr('PATCH', '/shaman_bloginfo?' + hostQuery, { article_selector: null, to_delete: null, last_updated: now()}, result => {
      ...
      if(ev.key == 'x'){
          ...
          if(first){
              ...
              setvalues(() => {
                  ...
                  xhr('PATCH', '/shaman_bloginfo?' + hostQuery, { example_url: window.location.href, to_delete: blogInfo.to_delete, last_updated: now()}, result => {
      ...
      if(ev.key == 'p'){
          ...
          if(first){
              ...
              setvalues(() => {
                  xhr('PATCH', '/shaman_bloginfo?' + hostQuery, {example_url: window.location.href, article_selector: cosmeticFilterFromElement(first, true), last_updated: now()}, result => {
